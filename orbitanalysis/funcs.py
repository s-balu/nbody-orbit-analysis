...
def load_halo_particle_ids_gadget(snapshot_obj, catalogue_obj,
    ...
    snapshot_ = GadgetSnapshot(
        ...
        unit_length_in_cm=snapshot_obj.unit_length_in_cm,
        unit_mass_in_g=snapshot_obj.unit_mass_in_g,
        unit_velocity_in_cm_per_s=snapshot_obj.unit_velocity_in_cm_per_s,
